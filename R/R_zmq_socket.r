...
#' @rdname a1_socket
#' @export
zmq.socket <- function(ctx, type = .zmqopt_get("ZMQ.ST", "REP")){
...
#' @rdname a1_socket
#' @export
zmq.bind <- function(socket, endpoint, MC = .zmqopt_get("ZMQ.MC")){
...
#' @rdname a1_socket
#' @export
zmq.connect <- function(socket, endpoint, MC = .zmqopt_get("ZMQ.MC")){
...
#' @rdname a1_socket
#' @export
zmq.disconnect <- function(socket, endpoint, MC = .zmqopt_get("ZMQ.MC")){
...
#' @rdname a1_socket
#' @export
zmq.setsockopt <- function(socket, option.name, option.value, MC = .zmqopt_get("ZMQ.MC")){
