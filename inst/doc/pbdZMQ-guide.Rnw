...
\Plainauthor{Wei-Chen Chen, Drew Schmidt, George Ostrouchov} %% comma-separated
\Plaintitle{Quick Guide for pbdZMQ (Ver. \mpiversion)} %% without formatting
\Shorttitle{Quick Guide for pbdZMQ (Ver. \mpiversion)} %% a short title (if necessary)
